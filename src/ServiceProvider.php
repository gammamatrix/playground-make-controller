...
namespace Playground\Make\Controller;
...
class ServiceProvider extends AuthServiceProvider
{
    ...
    public string $package = 'playground-make-controller';
    ...
    public function register(): void
    {
        $this->mergeConfigFrom(
            dirname(__DIR__).'/config/playground-make-controller.php',
    ...
    public function about(): void
    {
        ...
        AboutCommand::add('Playground: Make Controller', fn () => [
